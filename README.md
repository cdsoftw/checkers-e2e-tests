...
This repository contains a detailed end-to-end test plan for a simple browser-based [checkers game](https://www.gamesforthebrain.com/game/checkers/). It also contains a skeleton test codebase in Playwright for Node.js and TypeScript, as well as a few test cases created within a ~2 hour window.
